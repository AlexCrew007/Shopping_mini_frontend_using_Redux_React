...
export const Product = ({title,price,description,image,selected,setSelected,id}) => {
  ...
  const currObj={title,price,description,image,selected,setSelected,id}

  function addToCartHandler(){
    dispatch(add(currObj))
    toast.success("Item added")
  }
  return (
    <div className='flex flex-col items-center justify-between
    hover:scale-110 tarnsitio duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl outline'>
      <div>
      ...
      <div>
        {
          ...
          onClick={removeItemHandler}>Remove Item</button> : 
          <button 
           className='text-gray-700 border-2 border-gray-700
          rounded-full font-semibold text-[12px] p-1 px-3 uppercase
          hover:bg-gray-700
